  ...
  return (
    <div className="App">
      <div className="grid grid-rows-10 grid-cols-12">
        <div className="grid row-start-1 col-start-1 row-end-11 col-end-2 bg-red-100">
          <Sidebar />
        </div>
        <div className="grid row-start-1 col-start-2 row-end-11 col-end-13">
          <div className="grid row-start-1 col-start-1 row-end-2 col-end-11 place-content-center bg-yellow-100">
            <PageHeader />
          </div>
          <div className="grid row-start-2 col-start-1 row-end-11 col-end-11">
            <div className="grid row-start-1 col-start-1 row-end-10 col-end-4 bg-green-100">
              <DataAverager />
            </div>
            <div className="grid row-start-1 col-start-4 row-end-10 col-end-11">
              ...
              <div className="grid row-start-6 col-start-1 row-end-10 col-end-8 bg-indigo-100">
                <Map />
              </div>
            </div>
          </div>
